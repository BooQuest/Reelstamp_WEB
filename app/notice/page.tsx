...
const notices = [
  {
    ...
    description:
      '보다 안정적인 서비스 제공을 위한 기능 점검으로 인해 정식 출시 일정을 10월 5일로 변경하게 되었습니다. 남은 기간 동안 기능 안정성과 사용성을 더욱 꼼꼼히 점검하여 더 나은 모습으로 찾아뵙겠습니다. 정식 출시 전까지는 현재 베타 서비스를 계속 자유롭게 이용하실 수 있으며, 릴스탬프의 모든 템플릿을 무료로 사용하실 수 있습니다.',
  },
  {
    title: '릴스 템플릿이란?',
    description:
